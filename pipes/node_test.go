...
func TestNewNode(t *testing.T) {
	...
	node.NewNode(testCmd, testIPBuff, testOPBuff)
	// if(node.cmd==testCmd && node.stdin == testIPChan && node.stdout==testOPChan){
	// 	//pass
	// }else{
	// 	//fail
	// 	t.Fatalf("Unable to initialize the node correctly")
	// }
